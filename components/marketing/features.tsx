...
const items = [
  {
    ...
    header: <Image src={timeTrack} alt="Effortless time tracking" />,
  ...
  },
  {
    ...
    header: <Image src={smartSuggestions} alt="Smart Suggestions" />,
  ...
  },
  {
    ...
    header: <Image src={automatedReminders} alt="Automated Reminders" />,
    className: "md:col-span-1",
  ...
  },
  {
    ...
    header: <Image src={workAllocation} alt="Work Allocation" />,
    className: "md:col-span-1",
  ...
  },
  {
    ...
    header: <Image src={generateReports} alt="Generate Reports" />,
    className: "md:col-span-1",
    icon: <LucideGanttChartSquare className="h-4 w-4" />,
  },
  {
    ...
    header: <Image src={transparentTeams} alt="Transparent Teams" />,
    className: "md:col-span-1",
