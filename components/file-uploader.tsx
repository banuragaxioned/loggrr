...
export const FileUploaderContent = forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ children, className, ...props }, ref) => {
    ...
    return (
      <div className={cn("w-full px-1")} ref={containerRef} aria-details="content file holder">
        <div
          {...props}
          ref={ref}
          className={cn(
  ...
  ({ className, index, children, ...props }, ref) => {
    ...
    return (
      ...
      >
        ...
        <button
          type="button"
          className={cn("absolute text-destructive", direction === "rtl" ? "left-1 top-1" : "right-1 top-1")}
