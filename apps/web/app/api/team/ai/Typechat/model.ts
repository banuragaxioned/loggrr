...
export function createOpenAILanguageModel(
  ...
  const headers = {
    ...
    "OpenAI-Organization": org /* Uncomment this line if you are using an OpenAI organization */,
  };
 ...
 */
export function createFetchLanguageModel(url: string, headers: object, defaultParams: object) {
