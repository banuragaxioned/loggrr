...
export function DataTableFilterMenu<TData>({
  ...
  React.useEffect(() => {
    function onKeyDown(event: KeyboardEvent) {
      ...
      if (event.key.toLowerCase() === OPEN_MENU_SHORTCUT && event.shiftKey && !open && filters.length > 0) {
        event.preventDefault();
    ...
    return (
      <div
        ...
        <Popover open={showFieldSelector} onOpenChange={setShowFieldSelector}>
          ...
          <PopoverContent align="start" className="w-48 origin-[var(--radix-popover-content-transform-origin)] p-0">
            <Command loop>
