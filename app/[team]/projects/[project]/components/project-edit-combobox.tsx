  ...
  return (
    <Badge
      ...
      className={cn(
        ...
        compact ? "h-5 px-1 py-0 text-[8px] tracking-wide uppercase" : "px-1 py-0.5 text-[11px]",
      )}
    >
      Archived
    </Badge>
  ...
  return (
    <Popover open={open} onOpenChange={handleOpenChange}>
      <PopoverTrigger asChild>
        ...
        >
          ...
          <span className="flex min-w-0 flex-1 items-center gap-2">
            <span
              className={cn(
                "inline-flex max-w-[200px] min-w-0 items-center gap-0.5 overflow-hidden text-ellipsis whitespace-nowrap",
      ...
      <PopoverContent
        side="bottom"
        align="start"
        className={cn("bg-popover text-popover-foreground max-w-[256px] border-0 p-0", className)}
