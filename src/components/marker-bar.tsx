  ...
  return (
    <div className={className}>
      <div className="h-2 w-full overflow-hidden rounded-md bg-slate-200">
        <div className="absolute left-0 top-0 h-full max-w-full rounded-md bg-[#f43f5e]" style={{ width: `${maxValue}%` }} />
        <div className="absolute left-0 top-0 h-full max-w-full rounded-md bg-[#32ba80]" style={{ width: `${getGreenBarWidth()}%` }} />
      </div>
      <div className={`group absolute -top-[5px] h-[18px] w-[6px] rounded-md border-[1px] border-white bg-slate-400`} style={{ left: `${value}%` }}>
