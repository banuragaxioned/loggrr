                          ...
                          group?.list.map((item: any, innerI: any) => {
                            return (
                              <CommandItem
                                key={item.id}
                                value={item.value}
                                className="w-full cursor-pointer rounded px-[18px] py-2 text-text-color aria-selected:bg-hover"
                                onSelect={(val: string) => {
                  ...
                  : options?.map((item: any) => {
                    return (
                      <CommandItem
                        ...
                        className="w-full cursor-pointer rounded px-[14px] py-2 text-text-color aria-selected:bg-hover"
                      >
                        {item.name}
                      </CommandItem>
                    );
